...
async function loadHosts() {
  ...
  if (!host) { document.querySelector(".title-line h1").textContent = "Neuer Proxy Host"; renderTargets(); updateOverviewStrip().catch(()=>{}); return; }
